...
public class LineareAlgebraTest
{
    ...
    public void testAdd()throws Exception{
        ...
        Vector.Vector2D vec1 = new Vector.Vector2D(Double.MAX_VALUE,Double.MAX_VALUE);
        Vector.Vector2D vec2 = new Vector.Vector2D(Double.MAX_VALUE, Double.MAX_VALUE);
    ...
    public void testSub() throws Exception{
        expected.expect(ArithmeticException.class);
        Vector.Vector3D vec1 = new Vector.Vector3D(-Double.MAX_VALUE, -Double.MAX_VALUE,-Double.MAX_VALUE);
        Vector.Vector3D vec2 = new Vector.Vector3D(Double.MAX_VALUE, Double.MAX_VALUE, Double.MAX_VALUE);
    ...
    public void testMult2D() throws Exception{
        expected.expect(ArithmeticException.class);
        Vector.Vector2D vec1 = new Vector.Vector2D(-Double.MAX_VALUE, 2);
    ...
    public void testDiv2D() throws Exception{
        expected.expect(ArithmeticException.class);
        Vector.Vector2D vec1 = new Vector.Vector2D(2,3);
